...
useEffect(() => {
  ...
  const toggleModal = (item) => {
    if (type == "countries") {
      setModalData({
        title: `Update Country Real Estate Price`,
        value: item,
      ...
      setInputValue(item.realEstatePrice);
    } else if (type == "states") {
      setModalData({
        title: `Update State Real Estate Price`,
        value: item,
      ...
      setModalData({
        title: `Update City Real Estate Price`,
        value: item,
      ...
      setModalData({
        title: `Update Area Real Estate Price`,
        value: item,
      ...
      setModalData({
        title: `Update Apartment Real Estate Price`,
        value: item,
      ...
      setModalData({
        title: `Update Village Real Estate Price`,
        value: item,
  ...
  const priceUpdateHandler =async (id,value) => {
    ...
    let obj;
    if (type == "countries") {
      url = `http://api-maa.in.net/maa/country/real/estate/price/update/${id}`
      obj = {
        ...value,
        realEstatePrice:inputValue
      };
    } else if (type == "states") {
      url = `http://api-maa.in.net/maa/state/real/estate/price/update/${id}`
      obj = {
        ...value,
        realEstatePrice:inputValue
      };
    } else if (type == "cities") {
      url = `http://api-maa.in.net/maa/city/real/estate/price/update/${id}`
      obj = {
        ...value,
        realEstatePrice:inputValue
      };
    } else if (type == "areas") {
      url = `http://api-maa.in.net/maa/area/real/estate/price/update/${id}`
      obj = {
        ...value,
        realEstatePrice:inputValue
      };
    } else if (type == "apartments") {
      url = `http://api-maa.in.net/maa/apartment/real/estate/price/update/${id}`
      obj = {
        ...value,
        realEstatePrice:inputValue
      };
    } else if (type == "villages") {
      url = `http://api-maa.in.net/maa/village/real/estate/price/update/${id}`
      obj = {
        ...value,
        realEstatePrice:inputValue
      };
